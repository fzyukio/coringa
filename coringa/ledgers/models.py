...
from coringa.common.models import CommonModel
...
class WithLedgerModel(CommonModel):
    ledger = models.ForeignKey(Ledger, related_name="%(class)ss", on_delete=models.CASCADE)
...
class Transaction(WithLedgerModel):
    ...
    payee = models.ForeignKey(Payee, related_name='transactions', on_delete=models.PROTECT)
    ...
    def delete(self, using=None, keep_parents=False):
        # TODO: Handle deletion to delete Payee if it's the only transaction
